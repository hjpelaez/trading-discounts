---
name: template_skill
description: Una plantilla base para crear nuevas skills en este proyecto.
---
...
3. **IMPORTANTE**: Todos los planes de implementación (`implementation_plan.md`) deben ser escritos íntegramente en **español**.
